...
public class ItemServiceImplTest {
    ...
    public void getAllItems_whenUserNotFound_thenThrowUserNotFoundException() {
        ...
        int from = 0;
        int size = 10;
        when(userService.findUserById(ownerId)).thenThrow(new UserNotFoundException("User was not found"));

        assertThrows(UserNotFoundException.class, () -> itemService.getAllItemsByOwner(ownerId, from, size));
    }
    ...
    public void updateItem_whenUserNotFound_thenThrowUserNotFoundException() {
        ...
        assertThrows(UserNotFoundException.class, () -> itemService.update(itemDto, itemId, ownerId));
    }
    ...
    public void updateItem_whenItemNotFound_thenThrowItemNotFoundException() {
        ...
        assertThrows(ItemNotFoundException.class, () -> itemService.update(itemDto, itemId, ownerId));
    }
    ...
    public void findItemById_whenItemNotFound_thenThrowItemNotFoundException() {
        ...
        assertThrows(ItemNotFoundException.class, () -> itemService.findItemById(itemId, ownerId));
    }
    ...
    public void findItemById_whenOwnerNotFound_thenThrowItemNotFoundException() {
        ...
        assertThrows(UserNotFoundException.class, () -> itemService.findItemById(itemId, ownerId));
    }
...
//    }
    ...
    public void addComment_whenUserNotFound_thenThrowUserNotFoundException() {
        ...
        assertThrows(UserNotFoundException.class, () -> itemService.addComment(commentDto, itemId, ownerId));
    }
    ...
    public void addComment_whenItemNotFound_thenThrowItemNotFoundException() {
        ...
        assertThrows(ItemNotFoundException.class, () -> itemService.addComment(commentDto, itemId, ownerId));
    }
}
